...
direktorij = r"D:\\LovrOP/crna_podloga_250mm"  
...
# data_splits je rječnik, image_id, width, height, objects su liste
...
features = Features({
    ...
    "objects": Sequence(                                
        feature={
            ...
            "bbox": Sequence(Value(dtype='int64', id=None)),
...
hf_dataset.push_to_hub("LovrOP/crna_podloga_250mm", token=HF_TOKEN)
